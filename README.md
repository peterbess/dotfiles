...
Reproducible, minimal macOS development environment for Apple Silicon Macs. Takes a fresh machine from "Homebrew installed" to "ready to work" by running one script.
...
- [1Password](https://1password.com) with SSH agent enabled (for commit signing and SSH auth)
